...
public final class VehicleFactory {
    ...
    public VehicleFactory(Simulator simulator, double simulationTimestep, VehiclePrototypes vehPrototypes,
    ...
    public Vehicle create(VehicleType vehicleType, @Nullable Route route) {
        ...
        accelerationModel.setRelativeRandomizationS0(vehicleType.getRelativeS0Randomization(),
                vehicleType.getV0DistributionType());
        LaneChangeModel laneChangeModel = prototype.createLaneChangeModel();
        
        /*
         * Modify for DTMI
         *   initial : Vehicle vehicle = new Vehicle(prototype.getLabel(), accelerationModel, prototype.getConfiguration(),
                laneChangeModel);
                new :   Vehicle vehicle = new ProjectVehicle(prototype.getLabel(), accelerationModel, prototype.getConfiguration(),
                laneChangeModel);
         */
        Vehicle vehicle = new ProjectVehicle(prototype.getLabel(), accelerationModel, prototype.getConfiguration(),
                laneChangeModel);
        ...
        vehicle.setExternalControl(prototype.getExternalControl());
        vehicle.initializeExternalControl();
        vehicle.setTrustModel(prototype.createTrustModel());
        
        /**
         * Generic sensors creation
         *
         * @author mgueriau
         */
         ...
         */
         if(simulator.externalControlServer != null){
             if(vehicle.isExternalControl()){
            	 simulator.externalControlServer.addVehicleAgent(vehicle);
             }
         }
        /**
         * 
