...
/**
 * The Class EquilibriumBMA.
 */
public class EquilibriumBMA extends EquilibriumPropertiesImpl {

    /**
     * Instantiates a new equilibrium BMA.
     * 
     * @param length
     *            the length
     * @param model
     *            the BMA model
     */
    public EquilibriumBMA(double length, BMA model) {
        super(length);
     ...
     *            the model
     */
    private void calcEquilibrium(BMA model) {
