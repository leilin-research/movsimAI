...
public class AppFrame extends JFrame {
	...
	public AppFrame(ResourceBundle resourceBundle, ProjectMetaData projectMetaData, Properties properties) {
		...
		this.trafficCanvas = new TrafficCanvas(simulator, properties);
		this.editorCanvas = new EditorCanvas(this,simulator, properties);

		canvasPanel = new CanvasPanel(resourceBundle, trafficCanvas/*, editorCanvas*/);
		...
		add(editorCanvas, BorderLayout.WEST);
		 ...
		 */
		 if (projectMetaData.hasProjectName()) {
			 ...
			 trafficCanvas.setupTrafficScenarioWithoutResetting(projectMetaData.getProjectName(),
					 projectMetaData.getPathToProjectFile());
		 ...
		 //hack
		 this.editorCanvas.setVisible(true);
		 this.editorCanvas.setVisible(false);
	}
	 ...
	 */
	 ...
	 public void showEditorCanvas(boolean load){

		this.trafficCanvas.pause();

		this.editorCanvas.reset();
		if(load){
			this.editorCanvas.load();
		}
	 ...
	 public void hideEditorCanvas(){

		 this.editorCanvas.close();
		 this.editorCanvas.setVisible(false);
