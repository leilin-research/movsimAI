...
public class EquilibriumPropertiesFactory {
    ...
    public static EquilibriumProperties create(double vehLength, LongitudinalModelBase longModel) {
        ...
        } else if (longModel.modelName() == ModelName.FB) {
            return new EquilibriumFB(vehLength, (FB) longModel);
        } else if (longModel.modelName() == ModelName.BMA) {
            return new EquilibriumBMA(vehLength, (BMA) longModel);
        } else if (longModel.modelName() == ModelName.CalibratedIDM) {
            return new EquilibriumCalibratedIDM(vehLength, (CalibratedIDM) longModel);
        } else {
