...
/**
 * The Class EquilibriumFB.
 */
class EquilibriumFB extends EquilibriumPropertiesImpl {

    /**
     * Instantiates a new equilibrium FB.
     * 
     * @param length
     *            the length
     * @param model
     *            the FB model
     */
    EquilibriumFB(double length, FB model) {
        super(length);
     ...
     *            the model
     */
    private void calcEquilibrium(FB model) {
