...
/**
 * A read-only interface of the model parameters of the 'Bilateral Multi Anticipative Model' (BMA).
 * 
 * <p>
 ...
 * 
 */
public interface IModelParameterBMA extends IModelParameter {
