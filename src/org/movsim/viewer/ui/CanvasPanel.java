...
public class CanvasPanel extends JPanel {
    ...
    public CanvasPanel(final ResourceBundle resourceBundle, final TrafficCanvas trafficCanvas) {
        ...
        try {
            ...
            SwingUtilities.invokeAndWait(new Runnable() {
                @Override
                public void run() {
                    initApp(resourceBundle, trafficCanvas/*, editorCanvas*/);
                }
            });
    ...
    public void initApp(ResourceBundle resourceBundle, TrafficCanvas trafficCanvas1/*, EditorCanvas editorCanvas*/) {
