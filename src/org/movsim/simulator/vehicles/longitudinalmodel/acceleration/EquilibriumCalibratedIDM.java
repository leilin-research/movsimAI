 ...
 */
class EquilibriumCalibratedIDM extends EquilibriumPropertiesImpl {
     ...
     *            the idm model
     */
    EquilibriumCalibratedIDM(double length, CalibratedIDM model) {
        super(length);
     ...
     *            the model
     */
    private void calcEquilibrium(CalibratedIDM model) {
