...
public class TrafficCanvasMouseListener implements MouseListener, MouseMotionListener, MouseWheelListener {
    ...
    public void mouseClicked(MouseEvent e) {
        ...
        if (trafficCanvas.lastVehicleViewed != -1) {
            ...
            trafficCanvas.vehicleColorMode = VehicleColorMode.COOPERATIVE_COLOR;
    ...
    public void mouseWheelMoved(MouseWheelEvent e) {
        ...
        if (notches < 0) {
            logger.debug("Mouse wheel moved UP " + -notches + " notch(es)");
            controller.commandZoomIn();
        } else {
            logger.debug("Mouse wheel moved DOWN " + notches + " notch(es)");
