...
public class AppMenu extends MovSimMenuBase {
     ...
     * 13.12.13
     */
    private final String simulationFolder = "./sim";
    /**
     * 
     */
    ...
    private JMenu fileMenu() {
        ...
        menuFile.add(new JMenuItem(new AbstractAction(resourceString("FileMenuNew")) {//$NON-NLS-1$
            @Override
            public void actionPerformed(ActionEvent actionEvent) {
            	frame.showEditorCanvas(false);
            }
        })).setEnabled(true);
        
        menuFile.add(new JMenuItem(new EditAction(resourceString("FileMenuEdit")) {//$NON-NLS-1$
            @Override
            public void actionPerformed(ActionEvent actionEvent) {
            	frame.showEditorCanvas(true);
            }
        })).setEnabled(true);
    ...
    private JMenu scenarioMenu() {
        ...
        scenarioMenu.add(new JMenuItem(new AbstractAction(resourceString("OnRamp")) {
            ...
            public void actionPerformed(ActionEvent e) {
                trafficCanvas.setupTrafficScenario("onramp", simulationFolder + "/buildingBlocks/");
                uiDefaultReset();
            }
        }));
        ...
        scenarioMenu.add(new JMenuItem(new AbstractAction(resourceString("OffRamp")) {
            @Override
            public void actionPerformed(ActionEvent e) {
                trafficCanvas.setupTrafficScenario("offramp", simulationFolder + "/buildingBlocks/");
                uiDefaultReset();
            }
        }));
        ...
        scenarioMenu.add(new JMenuItem(new AbstractAction(resourceString("FlowConservingBottleNeck")) {
            @Override
            public void actionPerformed(ActionEvent e) {
                trafficCanvas.setupTrafficScenario("flow_conserving_bottleneck", simulationFolder + "/buildingBlocks/");
                uiDefaultReset();
            }
        }));
        ...
        scenarioMenu.add(new JMenuItem(new AbstractAction(resourceString("SpeedLimit")) {
            @Override
            public void actionPerformed(ActionEvent e) {
                trafficCanvas.setupTrafficScenario("speedlimit", simulationFolder + "/buildingBlocks/");
                uiDefaultReset();
            }
        }));
        ...
        scenarioMenu.add(new JMenuItem(new AbstractAction(resourceString("TrafficLight")) {
            @Override
            public void actionPerformed(ActionEvent e) {
                trafficCanvas.setupTrafficScenario("trafficlight", simulationFolder + "/buildingBlocks/");
                uiDefaultReset();
            }
        }));
        ...
        scenarioMenu.add(new JMenuItem(new AbstractAction(resourceString("LaneClosing")) {
            @Override
            public void actionPerformed(ActionEvent e) {
                trafficCanvas.setupTrafficScenario("laneclosure", simulationFolder + "/buildingBlocks/");
                uiDefaultReset();
            }
        }));
        ...
        scenarioMenu.add(new JMenuItem(new AbstractAction(resourceString("CloverLeaf")) {
            @Override
            public void actionPerformed(ActionEvent e) {
                trafficCanvas.setupTrafficScenario("cloverleaf", simulationFolder + "/buildingBlocks/");
                uiDefaultReset();
            }
        }));
        ...
        scenarioMenu.add(new JMenuItem(new AbstractAction(resourceString("RingRoad")) {
            @Override
            public void actionPerformed(ActionEvent e) {
                trafficCanvas.setupTrafficScenario("ringroad_1lane", simulationFolder + "/buildingBlocks/");
                uiDefaultReset();
            }
        }));
        ...
        scenarioMenu.add(new JMenuItem(new AbstractAction(resourceString("RingRoad2Lanes")) {
            @Override
            public void actionPerformed(ActionEvent e) {
                trafficCanvas.setupTrafficScenario("ringroad_2lanes", simulationFolder + "/buildingBlocks/");
                uiDefaultReset();
            }
        }));
        ...
        scenarioMenu.add(new JMenuItem(new AbstractAction(resourceString("GameRampMetering")) {
            @Override
            public void actionPerformed(ActionEvent e) {
                trafficCanvas.setupTrafficScenario("ramp_metering", simulationFolder + "/games/");
        ...
        scenarioMenu.add(new JMenuItem(new AbstractAction(resourceString("GameRouting")) {
            @Override
            public void actionPerformed(ActionEvent e) {
                trafficCanvas.setupTrafficScenario("routing", simulationFolder + "/games/");
                trafficCanvas.setVehicleColorMode(TrafficCanvas.VehicleColorMode.EXIT_COLOR);
                uiDefaultReset();
            }
        }));
        ...
        scenarioMenu.add(new JMenuItem(new AbstractAction(resourceString("3lanesIDM")) {
            @Override
            public void actionPerformed(ActionEvent e) {
                trafficCanvas.setupTrafficScenario("3lanesIDM", simulationFolder + "/suburban/");
                uiDefaultReset();
            }
        }));
        
        scenarioMenu.add(new JMenuItem(new AbstractAction(resourceString("Coop100")) {
            @Override
            public void actionPerformed(ActionEvent e) {
                trafficCanvas.setupTrafficScenario("3lanesCoop100", simulationFolder + "/suburban/");
                uiDefaultReset();
            }
        }));
        
        scenarioMenu.add(new JMenuItem(new AbstractAction(resourceString("Coop70")) {
            @Override
            public void actionPerformed(ActionEvent e) {
                trafficCanvas.setupTrafficScenario("3lanesCoop70", simulationFolder + "/suburban/");
                uiDefaultReset();
            }
        }));
        
        scenarioMenu.add(new JMenuItem(new AbstractAction(resourceString("Coop40")) {
            @Override
            public void actionPerformed(ActionEvent e) {
                trafficCanvas.setupTrafficScenario("3lanesCoop40", simulationFolder + "/suburban/");
                uiDefaultReset();
            }
        }));
        
        scenarioMenu.add(new JMenuItem(new AbstractAction(resourceString("Flocking100")) {
            @Override
            public void actionPerformed(ActionEvent e) {
                trafficCanvas.setupTrafficScenario("3lanesFlocking100", simulationFolder + "/suburban/");
                uiDefaultReset();
            }
        }));
        
        scenarioMenu.add(new JMenuItem(new AbstractAction(resourceString("Flocking70")) {
            @Override
            public void actionPerformed(ActionEvent e) {
                trafficCanvas.setupTrafficScenario("3lanesFlocking70", simulationFolder + "/suburban/");
                uiDefaultReset();
            }
        }));
        
        scenarioMenu.add(new JMenuItem(new AbstractAction(resourceString("Flocking40")) {
            @Override
            public void actionPerformed(ActionEvent e) {
                trafficCanvas.setupTrafficScenario("3lanesFlocking40", simulationFolder + "/suburban/");
                uiDefaultReset();
            }
        }));
...
//        }));
        ...
        scenarioMenu.add(new JMenuItem(new AbstractAction(resourceString("Vasaloppet")) {
            @Override
            public void actionPerformed(ActionEvent e) {
                trafficCanvas.setupTrafficScenario("vasa_CCS", simulationFolder + "/vasa/");
                uiDefaultReset();
