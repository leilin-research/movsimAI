...
public class AppletMenu extends MovSimMenuBase {
    ...
    public AppletMenu(CanvasPanel canvasPanel, TrafficCanvas trafficCanvas, StatusPanel statusPanel, ResourceBundle resourceBundle) {
        super(canvasPanel, trafficCanvas, resourceBundle, null); //FIXME : probably kills the applet side ...
    ...
    private JMenu scenarioMenu() {
        ...
        scenarioMenu.add(new JMenuItem(new AbstractAction(resourceString("3lanesIDM")) {
            @Override
            public void actionPerformed(ActionEvent e) {
                trafficCanvas.setupTrafficScenario("3lanesIDM", "/sim/suburban/");
                uiDefaultReset();
            }
        }));
        ...
        scenarioMenu.add(new JMenuItem(new AbstractAction(resourceString("Coop100")) {
            @Override
            public void actionPerformed(ActionEvent e) {
                trafficCanvas.setupTrafficScenario("3lanesCoop100", "/sim/suburban/");
                uiDefaultReset();
            }
        }));
        ...
        scenarioMenu.add(new JMenuItem(new AbstractAction(resourceString("Coop70")) {
            @Override
            public void actionPerformed(ActionEvent e) {
                trafficCanvas.setupTrafficScenario("3lanesCoop70", "/sim/suburban/");
                uiDefaultReset();
            }
        }));
        ...
        scenarioMenu.add(new JMenuItem(new AbstractAction(resourceString("Coop40")) {
            @Override
            public void actionPerformed(ActionEvent e) {
                trafficCanvas.setupTrafficScenario("3lanesCoop40", "/sim/suburban/");
                uiDefaultReset();
            }
        }));
        ...
        scenarioMenu.add(new JMenuItem(new AbstractAction(resourceString("Flocking100")) {
            @Override
            public void actionPerformed(ActionEvent e) {
                trafficCanvas.setupTrafficScenario("3lanesFlocking100", "/sim/suburban/");
                uiDefaultReset();
            }
        }));
        ...
        scenarioMenu.add(new JMenuItem(new AbstractAction(resourceString("Flocking70")) {
            @Override
            public void actionPerformed(ActionEvent e) {
                trafficCanvas.setupTrafficScenario("3lanesFlocking70", "/sim/suburban/");
                uiDefaultReset();
            }
        }));
        ...
        scenarioMenu.add(new JMenuItem(new AbstractAction(resourceString("Flocking40")) {
            @Override
            public void actionPerformed(ActionEvent e) {
                trafficCanvas.setupTrafficScenario("3lanesFlocking40", "/sim/suburban/");
                uiDefaultReset();
            }
        }));
