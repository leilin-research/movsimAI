...
public class LongitudinalModelFactory {
    ...
    public static LongitudinalModelBase create(double vehLength, AccelerationModelType longitudinalModelType,
        ...
        } else if (longitudinalModelType.isSetModelParameterFB()) {
            longModel = new FB(longitudinalModelType.getModelParameterFB());
        } else if (longitudinalModelType.isSetModelParameterBMA()) {
            longModel = new BMA(longitudinalModelType.getModelParameterBMA());
        } else if (longitudinalModelType.isSetModelParameterCalibratedIDM()) {
            longModel = new CalibratedIDM(longitudinalModelType.getModelParameterCalibratedIDM());
        } else {
